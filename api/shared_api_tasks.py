...
from reconPoint.common_func import create_inappnotification, get_hackerone_key_username
from reconPoint.definitions import PROJECT_LEVEL_NOTIFICATION, HACKERONE_ALLOWED_ASSET_TYPES
from reconPoint.celery import app
from reconPoint.database_utils import bulk_import_targets
...
def import_hackerone_programs_task(handles, project_slug, is_sync = False):
	...
	for handle in handles:
		...
		if program_details:
			...
			# via PR https://github.com/khulnasoft/reconpoint/pull/1410
			try:
