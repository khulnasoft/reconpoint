!(function (l) {
  ...
  (t.prototype._reset = function () {
    ...
    (t.prototype.initMenu = function () {
      ...
      this._reset(),
        l(".button-menu-mobile").on("click", function (t) {
          ...
          991 <= i.window.width() ? ("condensed" === e ? i.changeSize(a) : i.changeSize("condensed")) : (i.changeSize(a), i.body.toggleClass("sidebar-enable"));
        }),
        l("#side-menu").length &&
    ...
    (t.prototype.initLayout = function () {
      (this.window.width() <= 991) || this.body.data("keep-enlarged") ? this.changeSize("condensed") : this.changeSize("default");
    }),
      ...
      (t.prototype.init = function () {
        ...
        i(document).on("click", ".right-bar-toggle", function () {
          ...
          i("#dark-mode-check").change(function () {
            if (this.checked) {
              localStorage.setItem("reconpoint-theme","dark");
              e.layout.changeMode("dark", !0), e.selectOptionsFromConfig();
            }
            else {
              localStorage.setItem("reconpoint-theme",null);
    ...
    (t.prototype.initControls = function () {
      ...
      (t.prototype.init = function () {
        i.Portlet.init(),
          ...
          this.layout.leftSidebar.initLayout();
