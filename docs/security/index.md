# Report Security Vulnerabilities in reconPoint
...
Security Researchers, welcome onboard! I am excited to announce bug bounty program for reconPoint in collaboration with [huntr.dev](https://huntr.dev), **this means you'll be rewarded for any security vulnerabilities discovered in reconPoint.**

Thank you for your interest in reporting vulnerabilities to reconPoint! If you are aware of potential security vulnerabilities within reconPoint, we encourage you to report immediately via [huntr.dev](https://huntr.dev/bounties/disclose/?target=https%3A%2F%2Fgithub.com%2Fkhulnasoft%2Freconpoint)

!!!danger
    **Please do not disclose any vulnerabilities via Github Issues/Blogs/Tweets after/before reporting on huntr.dev as it is explicitly against huntr.dev and reconPoint disclosure policy and will not be eligible for monetary rewards.**

Please note that the maintainer of reconPoint does not determine the bounty amount.
...
You can [report the security vulnerabilities from here](https://huntr.dev/bounties/disclose/?target=https%3A%2F%2Fgithub.com%2Fkhulnasoft%2Freconpoint).
