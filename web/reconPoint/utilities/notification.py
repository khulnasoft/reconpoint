...
from reconPoint.definitions import DISCORD_SEVERITY_COLORS, REQUEST_TIMEOUT_SECONDS
from reconPoint.settings import DOMAIN_NAME, SECATOR_CELERY_BROKER_URL
