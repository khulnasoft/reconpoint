...
const getRequiredReconNoteUrl = function(key) {
  const urls = window.RECONPOINT_PAGE_URLS || {};
...
const populateScanHistory = function(project) {
  ...
  const baseUrl = (typeof window.RECONPOINT_API_LIST_SCAN_HISTORY_URL !== 'undefined' && window.RECONPOINT_API_LIST_SCAN_HISTORY_URL)
    ? window.RECONPOINT_API_LIST_SCAN_HISTORY_URL
    : '/api/listScanHistory/';
