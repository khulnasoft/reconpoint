...
class TestLLMVulnerabilityReport(TestLLMBase):
    ...
    @patch("reconPoint.llm.llm.LLMVulnerabilityReportGenerator._get_openai_response")
    ...
    @patch("reconPoint.llm.llm.LLMVulnerabilityReportGenerator._get_section_response")
...
class TestLLMAttackSuggestion(TestLLMBase):
    ...
    @patch("reconPoint.llm.llm.LLMAttackSuggestionGenerator._get_openai_response")
