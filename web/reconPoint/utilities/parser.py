...
from reconPoint.definitions import NMAP, NUCLEI_SEVERITY_MAP
from reconPoint.utilities.logger import get_module_logger
from reconPoint.utilities.url import sanitize_url
...
def process_nmap_service_results(xml_file):
    ...
    from reconPoint.utilities.port import create_or_update_port_with_service
