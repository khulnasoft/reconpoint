...
urlpatterns = [
    ...
    path("workflows/<int:workflow_id>/duplicate/", views.duplicate_workflow, name="duplicate_workflow"),
    ...
    path("profiles/<int:profile_id>/duplicate/", views.duplicate_profile, name="duplicate_profile"),
    ...
    path("workers/<int:worker_id>/duplicate/", views.duplicate_worker, name="duplicate_worker"),
