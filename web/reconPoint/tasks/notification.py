...
from reconPoint.definitions import NUCLEI_SEVERITY_MAP, STATUS_TO_SEVERITIES
...
def send_file_to_discord(file_path, title=None):
    ...
    webhook = DiscordWebhook(
        url=notif.discord_hook_url, rate_limit_retry=True, username=title or "reconPoint Discord Plugin"
    )
